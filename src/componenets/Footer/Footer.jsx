        ...
        <div className="w-screen bg-[rgb(29,32,37)] text-white flex-wrap pt-12">
            ...
            <div className="md:flex items-center justify-center pb-12">
                <div className="massage lg:px-16 px-6 md:w-2/4">
                    <h1 className="text-3xl font-bold md:text-4xl pb-6 text-center">Write me a line</h1>
                ...
                <div className="md:w-2/4 lg:space-y-9 lg:px-16 px-6  mt-12">
                    <p className=" text-3xl md:text-4xl mb-6 font-bold text-center">Contact With Me</p>
                    <p className="leading-7">Lorem ipsum dolor sit amet consectetur adipisicing elit. Officia corporis accusantium error quibusdam neque quas eaque fugiat temporibus harum dolor.</p>
            ...
            <div className="">
                ...
                <div className="flex justify-center lg:gap-22 md:gap-6 py-2 gap-6">
                    <span className="text-4xl text-slate-400 duration-500 hover:text-[rgb(184,19,134)]"> <ion-icon name="logo-google"></ion-icon> </span>
                    <span className="text-4xl text-slate-400 duration-500 hover:text-[rgb(184,19,134)]"> <ion-icon name="logo-facebook"></ion-icon> </span>
                    <span className="text-4xl text-slate-400 duration-500 hover:text-[rgb(184,19,134)]"> <ion-icon name="logo-apple"></ion-icon> </span>
                    <span className="text-4xl text-slate-400 duration-500 hover:text-[rgb(184,19,134)]"> <ion-icon name="logo-twitter"></ion-icon> </span>
                </div>
            </div>
